...
const RUBRIC: readonly RubricItem[] = [
  ...
  },
  {
    ...
    criteria: [
      'creo-ui-icon default: `currentColor` (text-color から継承)',
      'creo-ui-icon variant: data-variant で semantic 変更 (primary / success / warning / error 等)',
  ...
  return (
    <>
        ...
        >
          <For each={['xs', 's', 'm', 'l', 'xl'] as const}>
            {(size) => (
              ...
              >
                <span class="creo-ui-icon" data-size={size} aria-hidden="true">
                  ★
                </span>
        ...
        <div style={{ display: 'flex', 'flex-wrap': 'wrap', gap: 'var(--spacing-m)' }}>
          ...
          >
            {(variant) => (
              ...
              >
                <span class="creo-ui-icon" data-size="m" data-variant={variant} aria-hidden="true">
                  ●
                </span>
      ...
      <section>
        ...
        <pre class="docs-code">
          <code>{`<!-- creo-ui-icon CSS class (Nerd Font glyph) -->
<span class="creo-ui-icon" data-size="m" aria-hidden="true"></span>
<span class="creo-ui-icon" data-size="l" data-variant="success">✓</span>

<!-- Inline 使用 (button 内) -->
<button class="creo-btn" data-variant="primary">
  <span class="creo-ui-icon" data-size="s" aria-hidden="true">★</span>
  Favorite
</button>
...
/* a11y */
<!-- 装飾 icon -->
<span class="creo-ui-icon" aria-hidden="true">★</span>
