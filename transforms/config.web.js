 ...
 * Consumed by creo-ui (packages/web).
 *
 * Theme matrix (0.1.0+):
    ...
    formats: {
      'css/creo-ui-themed': ({ dictionary }) => {
        ...
        const header = [
          ...
          // NOTE: glob 表記 (tokens/**…json) は禁止 — 中の «*/» が CSS comment を
          // 早期終端させ、 consumer の esbuild が css-syntax-error warning を出す。
          ' * Source: DTCG token JSON under tokens/.',
          ' *',
