...
| font-size (md) | `typography.size.sm` |
...
<span class="creo-badge" data-variant="neutral" data-size="sm">12</span>

<!-- Inline with text -->
<h3>Settings <span class="creo-badge" data-variant="info" data-size="sm">Beta</span></h3>

<!-- Count (numeric) -->
<button class="creo-btn" data-variant="ghost">
  通知 <span class="creo-badge" data-variant="error" data-size="sm">3</span>
</button>
```
