# creoui Documentation

creoui Design System の architecture / migration / component spec のソース。 Living Documentation 原則 — code と doc は常に同期。
...
- @chronista-club/creoui-editor-host @0.5.0 — public type re-exports + DEV-gated console
...
- [Migration from-legacy-css](./migration/from-legacy-css.md) — 旧 hand-rolled CSS から creoui への移行 (legacy consumer 用)
...
- [`design/editor-mode.md`](./design/editor-mode.md) — Editor Mode protocol (D-1〜D-12)、 4 方向 semantic layout、 `@chronista-club/creoui-editor-host` の SolidJS reference 実装に対応
- [`design/frame-system.md`](./design/frame-system.md) — 3D Frame system (P-1〜P-6)、 `creoui-frame` package の spec、 morph / FLIP / spring の motion engine
...
- Linear Epic [CREO-84 — creoui Design System](https://linear.app/chronista/issue/CREO-84)
- npm [creoui](https://www.npmjs.com/package/creoui) / [@chronista-club/creoui-editor-host](https://www.npmjs.com/package/@chronista-club/creoui-editor-host)
