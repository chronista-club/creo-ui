...
- creoui-editor-host @0.5.0 — public type re-exports + DEV-gated console
...
- [`design/editor-mode.md`](./design/editor-mode.md) — Editor Mode protocol (D-1〜D-12)、 4 方向 semantic layout、 `creoui-editor-host` の SolidJS reference 実装に対応
...
- npm [creoui](https://www.npmjs.com/package/creoui) / [creoui-editor-host](https://www.npmjs.com/package/creoui-editor-host)
