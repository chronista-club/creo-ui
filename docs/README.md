...
- @chronista-club/creo-ui-editor-host @0.5.0 — public type re-exports + DEV-gated console
...
- [Migration from-legacy-css](./migration/from-legacy-css.md) — 旧 hand-rolled CSS から creo-ui への移行 (legacy consumer 用)
...
- [`design/editor-mode.md`](./design/editor-mode.md) — Editor Mode protocol (D-1〜D-12)、 4 方向 semantic layout、 `@chronista-club/creo-ui-editor-host` の SolidJS reference 実装に対応
