...
public enum CreoUITokens {
    ...
    public static let radiusSm: CGFloat = 8 // Small radius — subtle rounding (buttons, inputs)
    public static let radiusMd: CGFloat = 15 // Medium radius — cards, popovers (soft friendly feel)
    public static let radiusLg: CGFloat = 22 // Large radius — modals, larger surfaces
