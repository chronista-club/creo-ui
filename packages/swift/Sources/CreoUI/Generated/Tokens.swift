...
public enum CreoUITokens {
    ...
    public static let typographyBodyLead: CGFloat = 20.5 // Lead body — opening paragraph / intro (larger, invites reading)
    public static let typographyBodyDefault: CGFloat = 17 // Default body — regular paragraph text (最もよく使う)
    public static let typographyBodyEmphasis: CGFloat = 17 // Emphasis body — default size with stronger weight (意味的な強調、size は default と同じ)
    public static let typographyBodyHelper: CGFloat = 15 // Helper text — form helper, status message, secondary info
    public static let typographyBodyCaption: CGFloat = 13 // Caption — image caption, footnote, meta info (smallest readable body)
    ...
    public static let typographySizeXs: CGFloat = 13 // Caption / meta text
    public static let typographySizeS: CGFloat = 15 // Small body / helper text
    public static let typographySizeM: CGFloat = 17 // Default body text
    public static let typographySizeL: CGFloat = 18.5 // Large body / subheading
    public static let typographySizeXl: CGFloat = 20.5 // Largest body / small heading (h4)
    ...
    public static let typographyTitleCard: CGFloat = 20.5 // Card title — h4 (inline block title, table header, menu label)
    ...
    public static let typographyFamilySans: String = "'Gen Interface JP', 'UDEV Gothic 35NF', sans-serif" // 唯一の root font stack — Gen Interface JP (UI text) + UDEV Gothic 35NF (mono 由来の等幅数字・Nerd icon glyph 供給)。他の family token (mono / display / icon / app / read / editor / terminal 等) は 2026-07 の font 一本化 directive で廃止。末尾 sans-serif は CSS 保険の generic fallback
}
