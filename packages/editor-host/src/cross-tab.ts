/**
 * @chronista-club/creo-ui-editor-host — Cross-tab sync (F5)
 *
...
export interface CrossTabOptions {
  /** BroadcastChannel 名 (default: '@chronista-club/creo-ui-editor-host:{namespace}') */
  channel?: string
  /** namespace (localStorageNamespace と同値を期待、default '@chronista-club/creo-ui-editor-host') */
  namespace?: string
}
...
function defaultChannelName(namespace: string): string {
  return `@chronista-club/creo-ui-editor-host:${namespace}`
}
...
export function installCrossTabSync(host: EditorHost, opts: CrossTabOptions = {}): () => void {
  ...
  const namespace = opts.namespace ?? '@chronista-club/creo-ui-editor-host'
