  ...
  return (
    <header class="docs-header">
      <A class="docs-brand" href="/">
        <span class="docs-brand-logo" aria-hidden="true">◎</span>
      ...
      <nav class="docs-header-nav" aria-label="primary">
        <A href="/getting-started" activeClass="is-active">Get started</A>
        <A href="/components" activeClass="is-active">Components</A>
        <A href="/playground" activeClass="is-active">Playground</A>
      </nav>
